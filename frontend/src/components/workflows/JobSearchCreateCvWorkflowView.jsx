...
export default function JobSearchCreateCvWorkflowView({ viewModel }) {
  const {
    handleBackToResults,
    selectedJob,
    panelEyebrow,
  ...
  const isSingleColumnLayout =
    (showJobCvEntryPanel && !showJobCoverPanel) ||
    (!showActionsPanel && !cvReview);

  return (
    <div className="panel-page">
      <div className="panel-topbar-shell">
      ...
      <div className={`panel-body ${isSingleColumnLayout ? "is-single" : ""}`}>
        <>
